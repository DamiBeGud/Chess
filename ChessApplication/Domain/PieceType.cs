...
/// <summary>
/// PieceType is an enumeration within the Domain module.
/// Its named values model a bounded set of states, options, or outcomes used by collaborators.
/// Primary production consumers include ChessMoveApplication (Engine), ChessMoveGenerator (Engine), ChessGameStatusEvaluator (Engine).
/// Its values are interpreted by the services and models listed in the Used by section.
/// </summary>
/// <remarks>
/// <para><b>Used by:</b> ChessMoveApplication (Engine), ChessMoveGenerator (Engine), ChessGameStatusEvaluator (Engine), InitialPositionBuilder (Engine)</para>
