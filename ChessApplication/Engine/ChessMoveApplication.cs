...
/// <summary>
/// ChessMoveApplication is a concrete type within the Engine module.
/// It encapsulates module-specific behavior and exposes operations consumed by adjacent layers.
/// Primary production consumers include ChessStateTransitionService (Engine), ChessMoveGenerator (Engine), MoveLookupFailureReason (Engine).
/// No constructor-injected collaborators were detected in this declaration.
/// </summary>
/// <remarks>
/// <para><b>Used by:</b> ChessStateTransitionService (Engine), ChessMoveGenerator (Engine), MoveLookupFailureReason (Engine), ChessAttackDetector (Engine)</para>
