...
/// <summary>
/// ChessAttackDetector is a concrete type within the Engine module.
/// It encapsulates module-specific behavior and exposes operations consumed by adjacent layers.
/// Primary production consumers include ChessMoveGenerator (Engine), ChessGameEngine (Engine), ChessGameStatusEvaluator (Engine).
/// No constructor-injected collaborators were detected in this declaration.
/// </summary>
/// <remarks>
/// <para><b>Used by:</b> ChessMoveGenerator (Engine), ChessGameEngine (Engine), ChessGameStatusEvaluator (Engine)</para>
